export const tryParse = (parse: Function, code: string, id: string) => {
  try {
...
export function hasCjsKeywords(code: string, ignoreGlobal: boolean) {
  const firstpass = ignoreGlobal ? firstpassNoGlobal : firstpassGlobal;
  return firstpass.test(code);
}

export const normalizePathSlashes = (path: string) => path.replace(/\\/g, "/");
...
export const getIdFromExternalProxyId = (proxyId) =>
