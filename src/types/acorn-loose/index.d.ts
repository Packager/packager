...
declare module "acorn-loose" {
    ...
    interface Options {
        ...
        onInsertedSemicolon?: (lastTokEnd: number, lastTokEndLoc?: any) => void;
        onTrailingComma?: (lastTokEnd: number, lastTokEndLoc?: any) => void;
    ...
    function getLineInfo(input: string, offset: number): any;
    ...
    // TODO: rename type.
    type IParse = (input: string, options?: Options) => any;
