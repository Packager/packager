...
<ApiProps
    type="(moduleId: string, parentId: string | undefined) => string | false | void | { id: string, syntheticNamedExports?: boolean | null }"
    required="false"
/>
...
const amazingPlugin = {
    // ...
    resolver(moduleId: string, parentId?: string): string | null {
        if (!parentId) {
...
<Note>
    Only the files with extensions supplied in the extensions property will be
    affected.
</Note>
