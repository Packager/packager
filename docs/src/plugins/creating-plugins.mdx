...
<Note>
    All references to extensions and allowExternal need to be removed because it
    won't be featured in the plugin API.
</Note>
...
We first need to give our plugin a name and the extensions it should be triggered on.
