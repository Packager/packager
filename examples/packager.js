...
}(Transpiler));var generateExport = function (file, prependExportDefault) {
...
}(Transpiler));function stylusTransformer(context) {
...
}(Transpiler));function lessTransformer(context) {
...
}(Transpiler));var VueTranspiler = /** @class */ (function (_super) {
...
}(Transpiler));function vueTransformer(context) {
...
}(Transpiler));function typescriptTransformer(context) {
...
}(Transpiler));function svelteTransformer(context) {
...
}(Transpiler));function jsonTransformer(context) {
...
}(Transpiler));function coffeescriptTransformer(context) {
